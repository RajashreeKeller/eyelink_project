...
#timer
time.sleep(5)
# copy the files before deleting the duplicating files
...
#opens the file for second randomisation
...
# perform randomisation inside these folders encodinglist1, encodinglist2, encodinglist3
#def frame_capture(encoding_lis1_final):
 #   cap = cv2.VideoCapture(encoding_list1_final)
...
#for file in os.listdir(encoding_list1):
 #   if file.endswith(".mp4"):
 #       path=os.path.join(encoding_list1, file)
 #       frame_capture(path)
