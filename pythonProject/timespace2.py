...
#perform randomisation for encoding_list_3

encoding_list3_CC = random.choice(os.listdir(encoding_list3))
print(encoding_list3_CC)
encoding_list3_final = encoding_list3 + '\\' + encoding_list3_CC
print(encoding_list3_final)
cap2 = cv2.VideoCapture(encoding_list3_final)
while(cap2.isOpened()):
...
if encoding_list3_CC == encoding_list3_CC:
    source = encoding_list3_final
    destination= r"C:\Users\rajashreesa\PycharmProjects\pythonProject\venv\Trial\encoding_list3"
    new_path = shutil.copy(source,destination)
    print(new_path)

# avoid duplication : this step is where same type of files can not be repeated or played again
RM2_B1A = B1A + '\\' + encoding_list3_CC
RM2_B1H = B1H + '\\' + encoding_list3_CC
RM2_B2A = B2A + '\\' + encoding_list3_CC
RM2_B2H = B2H + '\\' + encoding_list3_CC
RM2_B3A = B3A + '\\' + encoding_list3_CC
RM2_B3H = B3H + '\\' + encoding_list3_CC
RM2_B4A = B4A + '\\' + encoding_list3_CC
RM2_B4H = B4H + '\\' + encoding_list3_CC
RM2_G1A = G1A + '\\' + encoding_list3_CC
RM2_G1H = G1H + '\\' + encoding_list3_CC
RM2_G2A = G2A + '\\' + encoding_list3_CC
RM2_G2H = G2H + '\\' + encoding_list3_CC
RM2_G3A = G3A + '\\' + encoding_list3_CC
RM2_G3H = G3H + '\\' + encoding_list3_CC
RM2_G4A = G4A + '\\' + encoding_list3_CC
RM2_G4H = G4H + '\\' + encoding_list3_CC
